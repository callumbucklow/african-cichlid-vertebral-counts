...
```{r Calculate Between Regime AICc Weights}

#i.e. a relative global comparison
combined_aicc_results_w_relative <- combined_aicc_results %>%
  group_by(tree_index) %>%  # compute within each tree
  mutate(
...
combined_aicc_results_w_relative_summary <- df %>%
...
combined_aicc_results_w_relative_summary

#export to desktop because I am so very tired
write.csv(combined_aicc_results_w_relative_summary, "~/Desktop/combined_aicc_results_w_relative_summary.csv")
```
