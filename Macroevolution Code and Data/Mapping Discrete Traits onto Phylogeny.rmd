...
all_species_piscivore_simmap <- make.simmap(tree = all_species_tree_piscivore_pruned, x = all_species_piscivore, model = 'ARD', nsim = 1000)
...
posterior_all_species_piscivore_simmap <- 
  describe.simmap(all_species_piscivore_simmap, plot = TRUE)
...
```{r Fit ARD Model for Piscivore Behaviour to All Species Tree (Ancestral Reconstruction)}
#Rescale all branches of the tree to 1
all_species_tree_piscivore_pruned$edge.length <- all_species_tree_piscivore_pruned$edge.length/all_species_tree_piscivore_pruned$edge.length

#Fit ARD model for piscivorous behaviour for all species onto the tree:
all_species_piscivore_simmap_scaled <- make.simmap(tree = all_species_tree_piscivore_pruned, x = all_species_piscivore, model = 'ARD', nsim = 1000)

#save the multiphylo simmap object so analysis doesn't need to be redone:
saveRDS(all_species_piscivore_simmap_scaled, 'Data/all_species_piscivore_simmap_scaled.rds')

#store all the trees simulated in the simmap creation, this will make it easier to plot the uncertainty at nodes etc.
posterior_all_species_piscivore_simmap_scaled <- 
  describe.simmap(all_species_piscivore_simmap_scaled, plot = TRUE)

#save simmap object as RDS - this is important if the simmap requires output for further analysis
saveRDS(posterior_all_species_piscivore_simmap_scaled, 'Data/posterior_all_species_piscivore_simmap_scaled.rds')
```

```{r Plot Simmap object for Piscivory for All Species}

#import the simmap object:
posterior_all_species_piscivore_simmap <- readRDS("Data/posterior_all_species_piscivore_simmap_scaled.rds")
...
#replace edge lengths with correct lengths for plotting
all_species_tree_piscivore_pruned$edge.length <- 
all_species_tree_piscivore_pruned_edges

pdf("Figures/Mapping Discrete Traits onto Phylogeny/posterior_all_species_piscivore_simmap_scaled.pdf", width = 8.4, height = 11)
...
plot(all_species_tree_piscivore_pruned,
     ...
     label.offset = 0.5,
     tip.color = tip_colours_vector)
nodelabels(pie=posterior_all_species_piscivore_simmap_scaled$ace,piecol=piscivore_colours,
cex=0.25)
# Add the legend
add.simmap.legend(colors=piscivore_colours, 
                  prompt=FALSE, 
...
#Fit ARD model for water system occupancy for all species onto the tree:
 all_species_water_system_simmap <- make.simmap(tree = all_species_tree_piscivore_pruned, x = all_species_water_system, model = 'SYM', nsim = 100)
# 
# #save the multiphylo simmap object so analysis doesn't need to be redone:
...
posterior_all_species_water_system_simmap <- 
 describe.simmap(all_species_water_system_simmap, plot = TRUE)
# 
# # Save simmap object as RDS - this is important if the simmap requires output for further analysis
...
#Fit ARD model for riverine or lacustrine for all species onto the tree:
 all_species_riverine_lacustrine_simmap <- make.simmap(tree = all_species_tree_piscivore_pruned, x = all_species_riverine_lacustrine, model = 'ARD', nsim = 1000)  
# 
# #save the multiphylo simmap object so analysis doesn't need to be redone:
...
# #store all the trees simulated in the simmap creation, this will make it easier to plot the uncertainty at nodes etc.
 posterior_all_species_riverine_lacustrine_simmap <- 
   describe.simmap(all_species_riverine_lacustrine_simmap, plot = TRUE)
# 
# #Save simmap object as RDS - this is important if the simmap requires output for further analysis
...
# #store all the trees simulated in the simmap creation, this will make it easier to plot the uncertainty at nodes etc.
 posterior_all_species_depth_simmap <- 
   describe.simmap(all_species_depth_simmap, plot = TRUE)
# 
#save simmap object as RDS - this is important if the simmap requires output for further analysis
...
depth_colours <- c("benthopelagic" = "#1E88E5",
                                "demersal" = "#FFC107", 
                                "pelagic" = "#004D40") 
...
```{r Fit ARD Model for Depth Preference to All Species Tree (Ancestral Reconstruction)}

#rescale branch lengths
all_species_tree_piscivore_pruned$edge.length <- all_species_tree_piscivore_pruned$edge.length/all_species_tree_piscivore_pruned$edge.length

# #Fit ARD model for piscivorous behaviour for all species onto the tree:
 all_species_depth_simmap_scaled <- make.simmap(tree = all_species_tree_piscivore_pruned, 
                                            x = all_species_depth, 
                                            model = 'ARD', nsim = 1000)
# 
# #save simmap object to prevent needing to redo the analysis:
 saveRDS(all_species_depth_simmap_scaled, 'Data/all_species_depth_simmap_scaled.rds')
# 
# #store all the trees simulated in the simmap creation, this will make it easier to plot the uncertainty at nodes etc.
 posterior_all_species_depth_simmap_scaled <- 
   describe.simmap(all_species_depth_simmap_scaled, plot = TRUE)
# 
#save simmap object as RDS - this is important if the simmap requires output for further analysis
saveRDS(posterior_all_species_depth_simmap_scaled, 'Data/posterior_all_species_depth_simmap_scaled.rds')
```

```{r Plot Simmap object for Depth Preference for All Species (Ancestral Reconstruction)}

#import the simmap with all 1000 trees:
posterior_all_species_depth_simmap_scaled <-
  readRDS('Data/posterior_all_species_depth_simmap_scaled.rds')
...
#replace branch lengths to original scale
all_species_tree_piscivore_pruned$edge.length <- all_species_tree_piscivore_pruned_edges 

pdf("Figures/Mapping Discrete Traits onto Phylogeny/posterior_all_species_depth_simmap_scaled.pdf", width = 8.4, height = 11)
...
plot(all_species_tree_piscivore_pruned,
     ...
     label.offset = 0.5,
     tip.color = tip_colours_vector)
nodelabels(pie=posterior_all_species_depth_simmap_scaled$ace,piecol=depth_colours,
cex=0.25)
...
#Fit SYM model for tribe for all species onto the tree:
set.seed(1931)
...
posterior_all_species_tribe_simmap <- 
  describe.simmap(all_species_tribe_simmap, plot = TRUE)

#Save simmap object as RDS - this is important if the simmap requires output for further analysis
saveRDS(posterior_all_species_tribe_simmap, 'Data/posterior_all_species_tribe_simmap.rds')
```

```{r Plot Simmap object for Tribe/Haplochromine for All Species}
