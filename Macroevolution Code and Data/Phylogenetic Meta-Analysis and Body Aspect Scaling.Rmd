...
# Analysis of individuals >=25 individuals
...
vertebral_counts_individual_counts_25_above_summary <- vertebral_counts_individual_counts_25_above_summary %>%
  mutate(aspect_ratio_range = cut(mean_aspect_ratio, 
                                  breaks = c(0.80, 1.25, 1.55, 1.70, 2.5), labels = c("Deep Bodied", "Elongate", "Elongate", "Very Elongate")))
...
a2 <- ggplot(vertebral_counts_individual_counts_25_above_summary_filtered, 
  ...
  xlab("Total Vertebral Count")+
  ylab("ln[Length] - ln[Depth]")+
  scale_x_continuous(breaks = seq(24, 40, by = 4))+  #keeps tick labels at 25-39
  coord_cartesian(xlim = c(24, 40))+  #prevents clipping while keeping axis range
...
ggsave("Figures/Analysis of Intraspecific Variation/total_count_by_aspect_ratio_clean.svg", a2, width = 22, height = 10, units = "cm")
```
